...
ticketPriceTotal = runners.reduce(sum, total = 0);
...
companies = runners.map(function(items){
...
//Runners Shirt-size "S"
let runnersSmallSizeShirt = [];

runnersSmallSizeShirt = runners.filter(item => item.shirt_size === "S");
